...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_fkotca2",  // Replace with your EmailJS Service ID
        "template_0qzr7hp",  // Replace with your EmailJS Template ID
        form.current,
        "io0W33P_n2lpQ0BNj"  // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
